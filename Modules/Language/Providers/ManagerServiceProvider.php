...
use Modules\Language\Console\CleanCommand;
use Modules\Language\Console\ExportCommand;
use Modules\Language\Console\FindCommand;
use Modules\Language\Console\ImportCommand;
use Modules\Language\Console\ResetCommand;
...
class ManagerServiceProvider extends ServiceProvider {
	...
	public function register()
	{
        ...
        $this->app->singleton('translation-manager', function ($app) {
            $manager = $app->make('Modules\Language\Manager');
            return $manager;
        });
	...
	public function boot()
	{
        ...
        $this->loadViewsFrom($viewPath, 'ls-language');
